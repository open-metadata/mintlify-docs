---
title: Sink
description: Learn to build custom sink connectors for Collate using Python SDK. Step-by-step guide with code examples to integrate and stream metadata efficiently.
