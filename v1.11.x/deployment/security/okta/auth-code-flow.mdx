...
<CardGroup cols={3}>
<Card title="Docker" href="/deployment/security/okta/docker" >
  Configure Okta SSO for Docker deployment.
</Card>
<Card title="Kubernetes" href="/deployment/security/okta/kubernetes" >
  Configure Okta SSO for Kubernetes deployment.
</Card>
<Card title="Bare Metal" href="/deployment/security/okta/bare-metal" >
