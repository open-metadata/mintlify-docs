---
title: Add Custom Properties | Collate Custom Properties
description: Learn how to add custom properties to external automator configurations in Collate. Complete schema documentation and implementation guide.
