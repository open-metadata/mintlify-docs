---
title: Resource Descriptor | Collate Resource Descriptor
description: Learn how Collate'sResourceDescriptor schema defines access control policies for data assets. Complete API reference with examples and implementation guide.
