---
title: Resource Permission | Collate Resource Permissions
description: Learn how to configure resource permissions in Collate'saccess control system. Define granular user access rights for data assets and metadata.
