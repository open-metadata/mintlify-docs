---
title: Pulsar Connection | Collate Pulsar Messaging Connection
description: Learn how to configure Pulsar messaging connections in Collate. Complete schema reference, connection parameters, and setup guide for Apache Pulsar integration.
