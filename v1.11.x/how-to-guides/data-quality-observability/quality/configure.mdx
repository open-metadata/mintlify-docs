...
Learn how you can use Collate to define Data Quality tests and measure your data reliability.

## Requirements

### Collate

You must have a running deployment of Collate to use this guide. Collate includes the following services:

* Collate server supporting the metadata APIs and user interface
* Elasticsearch for metadata search and discovery
* MySQL as the backing store for all metadata
* Airflow for metadata ingestion workflows

To deploy Collate checkout the [deployment guide](/deployment)
...
Collate is where all users share and collaborate around data. It is where you make your assets discoverable; with data quality you make these assets **trustable**.

This section will show you how to configure and run Data Quality pipelines with the Collate built-in tests.
