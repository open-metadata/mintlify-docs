...
<img src="/public/images/v1.11/getting-started/add-service.png" alt="Adding Database Service" />
...
<img src="/public/images/v1.11/getting-started/select-service.png" alt="Selecting Database Service" />
...
<img src="/public/images/v1.11/getting-started/configure-connector.png" alt="Configure Service" />

<img src="/public/images/v1.11/getting-started/configure-connector.png" alt="Updating Connection Details" />

4. ## Test the Connection
Click Test Connection to verify the setup. This will check if OpenMetadata can reach the Snowflake service.

<img src="/public/images/v1.11/getting-started/test-connection.png" alt="Verifying the Test Connection" />
