...
<CardGroup cols={1}>
<Card title="Run the connector in OpenMetadata" icon="plug" href="/v1.11.x/quick-start/getting-started/day-1/database-service-setup">
...
<CardGroup cols={2}>
<Card title="Data Discovery" icon="magnifying-glass" href="/v1.11.x/how-to-guides/data-discovery">
Discover the right data assets to make timely business decisions.
</Card>
<Card title="Data Collaboration" icon="users" href="/v1.11.x/how-to-guides/data-collaboration">
Foster data team collaboration to enhance data understanding.
</Card>
<Card title="Data Quality & Observability" icon="chart-line" href="/v1.11.x/how-to-guides/data-quality-observability">
Trust your data with quality tests & monitor the health of your data systems.
</Card>
<Card title="Data Lineage" icon="diagram-project" href="/v1.11.x/how-to-guides/data-lineage">
Trace the path of data across tables, pipelines, and dashboards.
</Card>
<Card title="Data Insights" icon="lightbulb" href="/v1.11.x/how-to-guides/data-insights">
Define KPIs and set goals to proactively hone the data culture of your company.
</Card>
<Card title="Data Governance" icon="shield-check" href="/v1.11.x/how-to-guides/data-governance">
...
<CardGroup cols={2}>
<Card title="Admin Guide" icon="gear" href="/v1.11.x/how-to-guides/admin-guide">
Admin users can get started with OpenMetadata with just three quick and easy steps & know-it-all with the advanced guides.
</Card>
<Card title="Guide for Data Users" icon="user" href="/v1.11.x/how-to-guides/guide-for-data-users">
