...
<img src="/public/images/v1.11/quickstart/sandbox/login.png" alt="login" />


### 2. Add yourself as a user. Pick a few teams to be part of: Data is a team game.

<img src="/public/images/v1.11/quickstart/sandbox/create-user.png" alt="user" />


### 3. Go on a tour and start discovering the power of metadata & collaboration

<img src="/public/images/v1.11/quickstart/tour.png" alt="tour" />
